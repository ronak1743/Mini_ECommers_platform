...
<div class="card login shadow-lg" style="max-width: 700px; width: 100%;">
    <div class="login-img-header d-flex align-items-center justify-content-center">
        <h1 class="text-white display-4">Sign Up</h1>
    </div>
        ...
        <form action="createuser" method="post" class="needs-validation" novalidate>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6 text-md-end mt-2 mt-md-0">
                    <a href="http://localhost:9090/Mini_E-commers_Platform/login.jsp" class="text-primary text-decoration-none fw-semibold">Have account? Sign in</a>
                </div>
            </div>
